...
const LMSLoginPage = () => {
  ...
  const handleLogin = () => {
    ...
    if (email === 'StudentID@v-edu.us' && password === 'V-edu.us1') {
      ...
      (email === 'smweah@hotmail.com' && password === 'Vedu@123') ||
      ...
      sessionStorage.setItem(
        'authUserName',
        email === 'smweah@hotmail.com'
          ? 'Michael'
          : email === 'go.ccam.global@gmail.com'
          ? 'Oluwatayo'
          : email === 'Jlgoeh@gmail.com'
          ? 'Josheph'
          : 'Nathaniel'
      );
      navigate('/lms-dashboard');
      ...
      (email === 'ronhayes.sr@gmail.com' && password === 'Vedu@123')
    ) {
      sessionStorage.setItem('authUserEmail', email);
      sessionStorage.setItem('authUserName', 'Ron Hayes');
      navigate('/lms-dashboard');
    } else {
