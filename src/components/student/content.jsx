      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-start border-t-4 border-blue-500">
          ...
          <div className="flex items-baseline gap-3 mb-2">
            <span className="text-3xl font-bold text-[#142d4f]">$2,999</span>
        ...
        <a href="/onetoone" style={{ textDecoration: "none" }}>
          <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-start border-t-4 border-violet-500 cursor-pointer hover:scale-105 transition">
            ...
            <div className="flex items-baseline gap-3 mb-2">
              <span className="text-3xl font-bold text-[#142d4f]">$5,999</span>
              <span className="line-through text-gray-400 text-xl">7,500</span>
            </div>
