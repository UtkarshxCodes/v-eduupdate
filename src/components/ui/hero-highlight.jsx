...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-sky-300 via-blue-500 to-blue-900 px-1 pb-1 dark:from-sky-400 dark:via-blue-600 dark:to-blue-900`,
        className
      )}>
      {children}
    </motion.span>
